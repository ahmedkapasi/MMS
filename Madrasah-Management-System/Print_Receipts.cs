...
namespace Madrasah_Management_System
{
    public partial class Print_Receipts : Form
    {
        ...
        private void btn_print_Click(object sender, EventArgs e)
        {
            ...
            {
                printRentReceipt(rcpt.ToString());
            }
            else {
                if (cmb_type.Text == "Fees") {
                    printFeesReceipt(rcpt.ToString());
                }
            }
        }

        private void printRentReceipt(string id_value)
        {
        ...
        private void printFeesReceipt(string id_value)
        {
